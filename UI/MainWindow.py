...
"QIcon{background-color:rga(1,1,1);}"))
        ...
        self.prev_page = QtGui.QToolButton(self.groupFrame)
        ...
        self.prev_page.setObjectName(_fromUtf8("prev_page"))
        self.horizontalLayout_2.addWidget(self.prev_page)
        self.page_num = QtGui.QComboBox(self.groupFrame)
        self.page_num.setMaximumSize(QtCore.QSize(16777215, 15))
        self.page_num.setStyleSheet(_fromUtf8("font: italic 9pt \"Microsoft Tai Le\";"))
        self.page_num.setObjectName(_fromUtf8("page_num"))
        self.horizontalLayout_2.addWidget(self.page_num)
        self.next_page = QtGui.QToolButton(self.groupFrame)
        ...
        self.next_page.setObjectName(_fromUtf8("next_page"))
        self.horizontalLayout_2.addWidget(self.next_page)
        self.total_pages = QtGui.QLabel(self.groupFrame)
        self.total_pages.setMaximumSize(QtCore.QSize(100, 15))
        self.total_pages.setStyleSheet(_fromUtf8("font: italic 9pt \"Microsoft Tai Le\";"))
        self.total_pages.setObjectName(_fromUtf8("total_pages"))
        self.horizontalLayout_2.addWidget(self.total_pages)
        spacerItem1 = QtGui.QSpacerItem(326, 24, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.prev_page.setText(_translate("MainWindow", "...", None))
        self.next_page.setText(_translate("MainWindow", "...", None))
        self.total_pages.setText(_translate("MainWindow", "Of ## Pages", None))
