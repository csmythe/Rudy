...
"}"))
        ...
        self.delete_matter = QtGui.QToolButton(self.centralwidget)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("Icons/delete.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.delete_matter.setObjectName(_fromUtf8("delete_matter"))
        ...
        self.clearPath = QtGui.QToolButton(self.documentGroup)
        self.clearPath.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.clearPath.setObjectName(_fromUtf8("clearPath"))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/note.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/arrow-1.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MatterWindow):
        ...
        self.delete_matter.setText(_translate("MatterWindow", "Delete", None))
        ...
        self.clearPath.setText(_translate("MatterWindow", "Clear Dir.", None))
